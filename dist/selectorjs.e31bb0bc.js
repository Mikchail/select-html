...
var getTemplate = function getTemplate() {
  ...
  var seletedId = arguments.length > 2 ? arguments[2] : undefined;
...
var Select = /*#__PURE__*/function () {
  function Select(selector, options) {
    ...
    this.seletedId = (_options$selectedId = options.selectedId) !== null && _options$selectedId !== void 0 ? _options$selectedId : null;
  ...
  _createClass(Select, [{
    ...
    value: function clickHandler(event) {
      var _event$target$dataset = event.target.dataset,
          ...
          item = _event$target$dataset.item;
    ...
    get: function get() {
      ...
      return this.options.data.find(function (item) {
        return String(item.id) === _this.seletedId;
      });
    }
  }]);
...
},{"./bundle-url":"../../../../usr/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"select/select.scss":[function(require,module,exports) {
...
},{"./select/select":"select/select.js","./select/select.scss":"select/select.scss"}],"../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40717" + '/');
...
//# sourceMappingURL=/selectorjs.e31bb0bc.js.map